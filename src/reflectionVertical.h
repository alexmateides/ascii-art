#ifndef SEMESTRALKAMAKE_REFLECTION_H
#define SEMESTRALKAMAKE_REFLECTION_H
 ...
 *
 **=========================================
 * Reflects image along x axis
 * =========================================*/
class CReflectionVertical: public CFilter{
public:
    /**
     * Applies filter
     * @param surface
...
#endif //SEMESTRALKAMAKE_REFLECTION_H
